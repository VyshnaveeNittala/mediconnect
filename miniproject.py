...
class NotificationPage:
    def _init_(self, notifications_window):
...
class Student:
    def _init_(self, name, reg_number, medicine, frame):
        self.name = name
...
def main():
    ...
    def open_doctor_page():
        ...
        # For demonstration, let's just open another window with doctor's page label
